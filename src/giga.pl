...
extend_env_main_c :-
    ...
    nl,
    write("After the fire went down and the smoke cleared out a little bit, the rest of the corrdior becomes visibile."),
    nl,
...
inspect(south_corridor_exit_door) :-
    ...
    nl,
    write("If you want to go further, you need to find out a way to unlock it with something."),
    nl, !,
    nl.
...
inspect(south_corridor_exit_door) :-
    ...
    write("This exit leads out of the living space to the (plot_element) section of the ship."),
    nl,
    write("The door is unlocked, you can go through it."),
    nl, !,
    nl.
...
use(X, Y) :-
    have(X),
    have(Y),
    write("You don't know how to use those things togheter."),
    nl, !,
    nl.
